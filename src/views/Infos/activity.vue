    ...
    export default {
        ...
        methods: {
            ...
            handleSizeChange(val) {
                ...
                this.$nextTick(() =>
                    api.Infos.limitInfosByTypeAndCurrentPageAndPageSize(1, page, pageSize, function (res) {
            ...
            getActivities() {
                ...
                api.Infos.limitInfosByTypeAndCurrentPageAndPageSize(1, page, pageSize, function (res) {
                    _this.totalDataNumber = pageSize * res.body.data.totalPage;
                    _this.activities = res.body.data.resultList;
                    _this.activities.forEach(function (item, index) {
                        if (item.picUrl !== "null"){
