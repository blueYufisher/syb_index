  ...
  <div class="home">
    ...
    <div class="bread_crumbs">
      <ul id="crumbs">
        ...
        <li><span>&nbsp;/&nbsp;</span></li>
        <li><a href="#" class="crumbs_paper">社区资讯</a></li>
        <li><span>&nbsp;/&nbsp;</span></li>
        <li><router-link to="/base?url=activity"><a class="crumbs_paper" id="crumbs_active">{{crumbs_active}}</a></router-link></li>
      </ul>
    </div>
    <!--  bread_crumbs 结束  -->
  ...
  export default {
    ...
    methods: {
      ...
      switchType(num) {
        ...
        switch (num) {
          case "/base?url=activity":
            _this.crumbs_active = "创业沙龙"
            _this.getData(1, page, pageSize)
            break;

          case "/base?url=news":
            _this.crumbs_active = "通知新闻"
            _this.getData(2, page, pageSize)
            break;

          case "/base?url=knowledge":
            _this.crumbs_active = "创业知识"
            _this.getData(3, page, pageSize)
            break;
        }
      },
...
<style scoped lang="scss" type="text/scss">
  ...
  .knowledge {
    background: url(../../assets/images/knowledge.png) no-repeat 0 0
  }
