  ...
  <div class="home">
    ...
    <div class="bread_crumbs">
      <ul id="crumbs">
        ...
        <li><span>&nbsp;/&nbsp;</span></li>
        <li><a href="#" class="crumbs_paper">团队风采</a></li>
      </ul>
    </div>
    <!--  bread_crumbs 结束  -->
          ...
          <div class="container">
            <div class="news_padding">
              ...
              <div class="w245 fr">
                ...
                <ul class="marketingArticle" v-for="(hotProj, i) in hotList">
                  <li><a href=''><router-link :to="{path:'/projectDetail', query:{id: hotProj.id}}">{{hotProj.projName}}</router-link></a></li>
                </ul>
              </div>
            </div>
          </div>
...
<script>
  /*eslint-disable */
  import $ from 'jquery'
  import {limitProjectsByCurrentPageAndPageSize, findProjectNumByVisit} from '/api/index.js'
  ...
  export default {
    ...
    methods: {
      ...
      getData(page, pageSize) {
        let _this = this
        limitProjectsByCurrentPageAndPageSize(page, pageSize).then(res => {
          _this.totalDataNumber = res.data.totalRecord
          _this.projects = _this.renderData(res.data.resultList)
          _this.loading = false
        })
      },
